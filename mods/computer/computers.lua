...
---------------------------Code cleanup by pitriss-------------------------------
---------------------------------------------------------------------------------

-- Generic Flat Screen LCD (16x9) with keyboard
computer.register_monitor("computer:monitor_on", {
...
computer.register_monitor("computer:monitor_bios", {
	...
	swap = "computer:monitor_loading";
})

computer.register_monitor("computer:monitor_loading", {
	...
	swap = "computer:monitor_login";
})

computer.register_monitor("computer:monitor_login", {
...
computer.register_monitor("computer:monitor", {
	tiles = {"computer_monitor_t.png", "computer_monitor_bt.png", "computer_monitor_l.png", "computer_monitor_r.png", "computer_monitor_b.png", "computer_monitor_f_off.png"},
	groups = {crumbly=3},
	swap = "computer:monitor_bios";
})
...
--WIFI Router (linksys look-a-like)
  ...
  minetest.register_node("computer:router", {
	...
	tiles = {"computer_router_t.png", "computer_router_bt.png", "computer_router_l.png", "computer_router_r.png", "computer_router_b.png",{name="computer_router_f_animated.png",  animation={type="vertical_frames", aspect_w=32, aspect_h=32, length=1.0}},},
	paramtype = "light",
	paramtype2 = "facedir",
	walkable = false,
...
minetest.register_node("computer:server", {
	...
	tiles = {'computer_server_t.png', 'computer_server_bt.png', 'computer_server_l.png', 'computer_server_r.png', 'computer_server_bt.png', 'computer_server_f_off.png'},
...
minetest.register_node("computer:server_on", {
	drawtype = "nodebox",
	description = "Rack Server",
	tiles = {'computer_server_t.png', 'computer_server_bt.png', 'computer_server_r.png', 'computer_server_l.png', 'computer_server_bt.png', 'computer_server_f_on.png'},

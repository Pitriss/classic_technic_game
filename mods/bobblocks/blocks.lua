...
minetest.register_craft({
	...
	recipe = {
		{"bobblocks:blueblock","bobblocks:redblock","bobblocks:whiteblock"},
		{"","",""},
		{"","",""},
	},
})
...
minetest.register_craft({
	output = "bobblocks:whitepole",
	recipe = {
		{"bobblocks:whiteblock","",""},
		{"default:stick","",""},
		{"","",""},
	},
})
...
minetest.register_craft({
	output = "bobblocks:orangepole",
	recipe = {
		{"bobblocks:orangeblock","",""},
		{"default:stick","",""},
		{"","",""},
	},
})
...
minetest.register_craft({
	output = "bobblocks:violetpole",
	recipe = {
		{"bobblocks:violetblock","",""},
		{"default:stick","",""},
		{"","",""},
	},
})
...
minetest.register_craft({
	output = "bobblocks:greenpole",
	recipe = {
		{"bobblocks:greenblock","",""},
		{"default:stick","",""},
		{"","",""},
	},
})
...
minetest.register_craft({
	output = "bobblocks:indigopole",
	recipe = {
		{"bobblocks:indigoblock","",""},
		{"default:stick","",""},
		{"","",""},
	},
})
